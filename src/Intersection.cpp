...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    TrafficLight::TrafficLightPhase trafficLightPhase{};
    trafficLightPhase = _trafficLight.getCurrentPhase();
    std::cout << "Current Traffic Light is : " << ((trafficLightPhase == TrafficLight::TrafficLightPhase::red) ? "red" : "green") << std::endl;
    if(trafficLightPhase == TrafficLight::TrafficLightPhase::red){
